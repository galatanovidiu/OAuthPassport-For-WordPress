		...
		<div className="oauth-clients">
			<Flex justify="space-between" align="center">
				<Text variant="title.small">
					{ __( 'OAuth Clients', 'oauth-passport' ) }
				</Text>
				<Button
					variant="primary"
							...
							{ Object.entries( availableScopes ).map(
								( [ scope, description ] ) => (
									<CheckboxControl
										...
										checked={ newClient.scopes.includes(
											scope
										) }
										onChange={ ( checked ) =>
						...
						<Flex justify="flex-end" gap="12px">
							...
							<Button
								...
								disabled={
									...
									! newClient.redirect_uri
								}
							>
								{ generating
									? __( 'Generating...', 'oauth-passport' )
									: __(
											'Generate Client',
											'oauth-passport'
									  ) }
			...
			{ generatedClient && (
				...
				>
					<Notice status="success" isDismissible={ false }>
						{ __(
							'Your OAuth client has been generated. Please save these credentials securely - the client secret will not be shown again.',
							'oauth-passport'
						) }
					</Notice>
